...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			//Заголовок мультисклад
			$data['head_multi'] = $this->language->get('head_multi');
			//
			...
			$data['text_ndc'] = $this->language->get('text_ndc');
			//
			...
			//Мультисклад
			$this->load->model('catalog/multi');
			$data['multi'] = $this->model_catalog_multi->getMulti($product_id);
